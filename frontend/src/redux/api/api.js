...
const api = createApi({
  ...
  endpoints: (builder) => ({
    ...
    MessageStatusDelivered: builder.mutation({
      query: ({ messageId, status }) => ({
        url: `/messages/${messageId}/delivered`,
        method: "PUT",
        credentials: "include",
    ...
    updateMessageStatusRead: builder.mutation({
      query: ({ messageId, status }) => ({
...
export const {
  ...
  useMessageStatusDeliveredMutation,
  useUpdateMessageStatusReadMutation,
