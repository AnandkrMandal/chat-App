...
const delivered = TryCatch(async (req, res) => {
  const { id } = req.params;
  try {
...
const seen = TryCatch(async (req, res) => {
  const { id } = req.params;
  try {
...
const editMassage = TryCatch(async (req, res)=> {
    const { id } = req.params;
